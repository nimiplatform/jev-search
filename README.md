...
2. **Search each source.** One [Search1API](https://www.search1api.com) call per source, using Google with `include_sites` and `time_range`. Sources: Hacker News, Reddit, GitHub, X, and the open web.
